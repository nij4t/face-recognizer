...
program
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, fr.train(classDirPath)];
            case 1:
                _a.sent();
...
program
    ...
    .action(function (serializedBiasesPath, imageSource) { return __awaiter(_this, void 0, void 0, function () {
    var prediction;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                fr.deserialize(serializedBiasesPath);
                return [4 /*yield*/, fr.predict(imageSource)];
            case 1:
                prediction = _a.sent();
...
fr.onnetworkready = function () { return program.parse(process.argv); };
